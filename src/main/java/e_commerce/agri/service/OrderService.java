...
public class OrderService {
	...
	public Map<String, Object> orderedItem(long productid, String farmerEmail, long quantity, String customerEmail)
			throws Exception {
		...
		// sendEmail(farmerEmail, "Order Confirmation", message,customerEmail); make to
		// call the function if other network when its connected----------
